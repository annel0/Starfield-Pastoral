...
function animated_java:cow/animations/pause_all
tag @s add aj.cow.animation.walk.playing
...
execute at @s run function animated_java:cow/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:cow/animations/walk/zzz/apply_frame {frame: $(to_frame)}
