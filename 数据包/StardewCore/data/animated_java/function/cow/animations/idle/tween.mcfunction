...
tag @s add aj.cow.animation.idle.playing
...
execute at @s run function animated_java:cow/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:cow/animations/idle/zzz/apply_frame {frame: $(to_frame)}
