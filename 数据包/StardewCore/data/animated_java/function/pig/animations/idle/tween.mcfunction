...
function animated_java:pig/animations/pause_all
tag @s add aj.pig.animation.idle.playing
...
execute at @s run function animated_java:pig/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:pig/animations/idle/zzz/apply_frame {frame: $(to_frame)}
