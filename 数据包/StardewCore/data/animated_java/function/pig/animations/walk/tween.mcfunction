...
tag @s add aj.pig.animation.walk.playing
...
execute at @s run function animated_java:pig/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:pig/animations/walk/zzz/apply_frame {frame: $(to_frame)}
