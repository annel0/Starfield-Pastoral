...
function animated_java:goat/animations/pause_all
tag @s add aj.goat.animation.idle.playing
...
execute at @s run function animated_java:goat/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:goat/animations/idle/zzz/apply_frame {frame: $(to_frame)}
