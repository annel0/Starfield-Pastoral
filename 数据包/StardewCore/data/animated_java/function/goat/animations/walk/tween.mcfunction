...
tag @s add aj.goat.animation.walk.playing
...
execute at @s run function animated_java:goat/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:goat/animations/walk/zzz/apply_frame {frame: $(to_frame)}
