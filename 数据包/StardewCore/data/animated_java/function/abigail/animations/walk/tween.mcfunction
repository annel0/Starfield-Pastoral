...
tag @s add aj.abigail.animation.walk.playing
...
execute at @s run function animated_java:abigail/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:abigail/animations/walk/zzz/apply_frame {frame: $(to_frame)}
