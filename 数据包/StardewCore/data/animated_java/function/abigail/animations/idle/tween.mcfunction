...
tag @s add aj.abigail.animation.idle.playing
...
execute at @s run function animated_java:abigail/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:abigail/animations/idle/zzz/apply_frame {frame: $(to_frame)}
