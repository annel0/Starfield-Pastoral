...
execute at @s run function animated_java:sheep_baby/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:sheep_baby/animations/idle/zzz/apply_frame {frame: $(to_frame)}
