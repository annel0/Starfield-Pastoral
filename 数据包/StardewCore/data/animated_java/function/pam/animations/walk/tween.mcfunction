...
tag @s add aj.pam.animation.walk.playing
...
execute at @s run function animated_java:pam/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:pam/animations/walk/zzz/apply_frame {frame: $(to_frame)}
