...
function animated_java:pam/animations/pause_all
tag @s add aj.pam.animation.idle.playing
...
execute at @s run function animated_java:pam/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:pam/animations/idle/zzz/apply_frame {frame: $(to_frame)}
