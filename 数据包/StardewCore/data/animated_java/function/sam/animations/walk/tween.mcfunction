...
tag @s add aj.sam.animation.walk.playing
...
execute at @s run function animated_java:sam/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:sam/animations/walk/zzz/apply_frame {frame: $(to_frame)}
