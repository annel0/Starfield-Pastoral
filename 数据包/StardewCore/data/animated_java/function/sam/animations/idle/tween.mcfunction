...
function animated_java:sam/animations/pause_all
tag @s add aj.sam.animation.idle.playing
...
execute at @s run function animated_java:sam/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:sam/animations/idle/zzz/apply_frame {frame: $(to_frame)}
