...
tag @s add aj.leah.animation.idle.playing
...
execute at @s run function animated_java:leah/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:leah/animations/idle/zzz/apply_frame {frame: $(to_frame)}
