...
function animated_java:leah/animations/pause_all
tag @s add aj.leah.animation.walk.playing
...
execute at @s run function animated_java:leah/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:leah/animations/walk/zzz/apply_frame {frame: $(to_frame)}
