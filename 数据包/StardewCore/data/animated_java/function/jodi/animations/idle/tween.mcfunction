...
tag @s add aj.jodi.animation.idle.playing
...
execute at @s run function animated_java:jodi/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:jodi/animations/idle/zzz/apply_frame {frame: $(to_frame)}
