...
function animated_java:jodi/animations/pause_all
tag @s add aj.jodi.animation.walk.playing
...
execute at @s run function animated_java:jodi/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:jodi/animations/walk/zzz/apply_frame {frame: $(to_frame)}
