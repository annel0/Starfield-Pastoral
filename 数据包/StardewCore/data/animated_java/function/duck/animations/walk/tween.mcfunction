...
function animated_java:duck/animations/pause_all
tag @s add aj.duck.animation.walk.playing
...
execute at @s run function animated_java:duck/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:duck/animations/walk/zzz/apply_frame {frame: $(to_frame)}
