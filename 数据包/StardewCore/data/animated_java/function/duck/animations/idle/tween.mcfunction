...
tag @s add aj.duck.animation.idle.playing
...
execute at @s run function animated_java:duck/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:duck/animations/idle/zzz/apply_frame {frame: $(to_frame)}
