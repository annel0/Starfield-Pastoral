...
function animated_java:alex/animations/pause_all
tag @s add aj.alex.animation.walk.playing
...
execute at @s run function animated_java:alex/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:alex/animations/walk/zzz/apply_frame {frame: $(to_frame)}
