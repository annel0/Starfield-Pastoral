...
tag @s add aj.alex.animation.idle.playing
...
execute at @s run function animated_java:alex/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:alex/animations/idle/zzz/apply_frame {frame: $(to_frame)}
