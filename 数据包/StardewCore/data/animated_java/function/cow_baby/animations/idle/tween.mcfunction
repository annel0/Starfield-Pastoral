...
tag @s add aj.cow_baby.animation.idle.playing
...
execute at @s run function animated_java:cow_baby/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:cow_baby/animations/idle/zzz/apply_frame {frame: $(to_frame)}
