...
function animated_java:jas/animations/pause_all
tag @s add aj.jas.animation.walk.playing
...
execute at @s run function animated_java:jas/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:jas/animations/walk/zzz/apply_frame {frame: $(to_frame)}
