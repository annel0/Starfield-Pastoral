...
tag @s add aj.jas.animation.idle.playing
...
execute at @s run function animated_java:jas/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:jas/animations/idle/zzz/apply_frame {frame: $(to_frame)}
