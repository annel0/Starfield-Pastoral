...
function animated_java:maru/animations/pause_all
tag @s add aj.maru.animation.walk.playing
...
execute at @s run function animated_java:maru/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:maru/animations/walk/zzz/apply_frame {frame: $(to_frame)}
