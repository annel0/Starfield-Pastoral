...
tag @s add aj.maru.animation.idle.playing
...
execute at @s run function animated_java:maru/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:maru/animations/idle/zzz/apply_frame {frame: $(to_frame)}
