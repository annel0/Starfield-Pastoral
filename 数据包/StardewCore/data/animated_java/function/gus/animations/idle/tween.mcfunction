...
function animated_java:gus/animations/pause_all
tag @s add aj.gus.animation.idle.playing
...
execute at @s run function animated_java:gus/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:gus/animations/idle/zzz/apply_frame {frame: $(to_frame)}
