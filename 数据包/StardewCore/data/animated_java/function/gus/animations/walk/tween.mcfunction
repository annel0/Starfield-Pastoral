...
tag @s add aj.gus.animation.walk.playing
...
execute at @s run function animated_java:gus/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:gus/animations/walk/zzz/apply_frame {frame: $(to_frame)}
