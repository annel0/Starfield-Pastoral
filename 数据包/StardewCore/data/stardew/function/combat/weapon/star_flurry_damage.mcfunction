...
execute store result score #player_x sd_temp run data get entity @p[tag=sd_using_star_flurry] Pos[0] 1000
execute store result score #player_z sd_temp run data get entity @p[tag=sd_using_star_flurry] Pos[2] 1000
