...
# 音效
execute as @e[tag=sd_blade_dance_target,limit=1] at @s run playsound minecraft:entity.player.attack.sweep player @a ~ ~ ~ 1.2 1.5
execute as @e[tag=sd_blade_dance_target,limit=1] at @s run playsound minecraft:item.trident.throw player @a ~ ~ ~ 0.6 1.6
