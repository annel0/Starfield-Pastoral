...
bossbar add stardew:dragon_combo_bar {"text":"🐉 龙牙连击 IV - 等待...","color":"yellow","bold":true}
...
scoreboard players set #250 sd_const 250
scoreboard players operation #damage sd_temp *= #250 sd_const
...
playsound minecraft:block.note_block.pling player @s ~ ~ ~ 0.8 2.0
particle minecraft:sweep_attack ^ ^1 ^1.5 0.3 0.3 0.3 0 5 force
