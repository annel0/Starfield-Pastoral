...
execute if score #total_motion stardew.animal.temp matches 10.. unless score @s stardew.animal.anim_state matches 1 run function stardew:animal/animated_java/play_walk_cow
execute if score #total_motion stardew.animal.temp matches 10.. run scoreboard players set @s stardew.animal.anim_state 1

# 如果静止
execute if score #total_motion stardew.animal.temp matches ..9 unless score @s stardew.animal.anim_state matches 0 run function stardew:animal/animated_java/play_idle_cow
