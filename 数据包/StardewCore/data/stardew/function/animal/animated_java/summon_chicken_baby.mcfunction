...
# 绑定 ID 到 root entity
execute as @e[tag=aj.chicken_baby.root,tag=!stardew.animal.aj_bound,sort=nearest,limit=1] run function stardew:animal/animated_java/bind_chicken_baby_id
