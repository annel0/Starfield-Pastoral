# stardew:weeds/raycast_single_weed.mcfunction
# 射线循环 - 寻找可放置单个杂草的位置
# 执行者: 玩家 (@s)
# 执行位置: 射线当前位置

# --- 1. 命中检测 ---
# 检测到非空气方块 -> 在方块上方生成单个杂草
...
execute if score @s sd_ray_steps matches ..50 positioned ^ ^ ^0.2 run function stardew:weeds/raycast_single_weed
