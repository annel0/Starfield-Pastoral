...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarf_scroll_i_unknown"}] if score @s sd_donated matches 100.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarf_scroll_ii_unknown"}] if score @s sd_donated matches 101.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarf_scroll_iii_unknown"}] if score @s sd_donated matches 102.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarf_scroll_iv_unknown"}] if score @s sd_donated matches 103.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"chipped_amphora_unknown"}] if score @s sd_donated matches 104.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"arrowhead_unknown"}] if score @s sd_donated matches 105.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"ancient_doll_unknown"}] if score @s sd_donated matches 106.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"elvish_jewelry_unknown"}] if score @s sd_donated matches 107.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"chewing_stick_unknown"}] if score @s sd_donated matches 108.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"ornamental_fan_unknown"}] if score @s sd_donated matches 109.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dinosaur_egg_unknown"}] if score @s sd_donated matches 110.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"rare_disc_unknown"}] if score @s sd_donated matches 111.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"ancient_sword_unknown"}] if score @s sd_donated matches 112.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"rusty_spoon_unknown"}] if score @s sd_donated matches 113.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"rusty_spur_unknown"}] if score @s sd_donated matches 114.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"rusty_cog_unknown"}] if score @s sd_donated matches 115.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"chicken_statue_unknown"}] if score @s sd_donated matches 116.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"ancient_seed_unknown"}] if score @s sd_donated matches 117.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_tool_unknown"}] if score @s sd_donated matches 118.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dried_starfish_unknown"}] if score @s sd_donated matches 119.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"anchor_unknown"}] if score @s sd_donated matches 120.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"glass_shards_unknown"}] if score @s sd_donated matches 121.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"bone_flute_unknown"}] if score @s sd_donated matches 122.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_handaxe_unknown"}] if score @s sd_donated matches 123.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarvish_helm_unknown"}] if score @s sd_donated matches 124.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"dwarf_gadget_unknown"}] if score @s sd_donated matches 125.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"ancient_drum_unknown"}] if score @s sd_donated matches 126.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"golden_mask_unknown"}] if score @s sd_donated matches 127.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"golden_relic_unknown"}] if score @s sd_donated matches 128.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"strange_doll_green_unknown"}] if score @s sd_donated matches 129.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"strange_doll_yellow_unknown"}] if score @s sd_donated matches 130.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_scapula_unknown"}] if score @s sd_donated matches 131.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_tibia_unknown"}] if score @s sd_donated matches 132.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_skull_unknown"}] if score @s sd_donated matches 133.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"skeletal_hand_unknown"}] if score @s sd_donated matches 134.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_rib_unknown"}] if score @s sd_donated matches 135.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"prehistoric_vertebra_unknown"}] if score @s sd_donated matches 136.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"skeletal_tail_unknown"}] if score @s sd_donated matches 137.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"nautilus_fossil_unknown"}] if score @s sd_donated matches 138.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"amphibian_fossil_unknown"}] if score @s sd_donated matches 139.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"palm_fossil_unknown"}] if score @s sd_donated matches 140.. run tag @s add sd_identified_success
...
execute if items entity @s weapon.offhand paper[custom_data~{artifact_type:"trilobite_unknown"}] if score @s sd_donated matches 141.. run tag @s add sd_identified_success
