# stardew:mine/floor/theme3/room2/generate.mcfunction
# 生成 theme3 room2 (40x5x40)
# 参数: $(z)
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme3/room2 0 64 $(z)
...
function stardew:mine/floor/theme3/room2/teleport with storage stardew:mine room

# ===== 生成出口梯子 (X=3, Z+4) =====
function stardew:mine/floor/theme3/room2/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme3/room2/spawn_elevator with storage stardew:mine room
