# stardew:mine/floor/theme3/treasure_room/generate.mcfunction
# 生成 theme3 宝藏房间 (30x6x40) - 仅在第75层出现
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme3/treasure_room 0 64 $(z)
...
# ===== 生成宝箱 (X=14, Z+12) - 使用 theme3 战利品表 =====
$execute in stardew:mine positioned 14 65 $(z) positioned ~ ~ ~12 run data remove block ~ ~ ~ Items
$execute in stardew:mine positioned 14 65 $(z) positioned ~ ~ ~12 run setblock ~ ~ ~ minecraft:chest[facing=south]{LootTable:"stardew:mining/treasure_room/theme3"}

# ===== 生成钓鱼区标记 (X=14, Z+27) =====
$execute in stardew:mine positioned 14 65 $(z) positioned ~ ~ ~27 run summon minecraft:marker ~ ~ ~ {Tags:["sd_fishing_spot","sd_mine_entity","sd_mine_theme3"]}
