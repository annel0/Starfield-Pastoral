# stardew:mine/floor/theme3/room4/generate.mcfunction
# 生成 theme3 room4 (30x5x20)
# 参数: $(z)
# 梯子: X=6 Z+3, 电梯: X=8 Z+3
# 特点: 没有 stripped_oak_log
...
# z+17 (矿石区域结束，20格房间留3格边界)
scoreboard players operation #z17 sd_mine_temp = #base_z sd_mine_temp
scoreboard players add #z17 sd_mine_temp 17

# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme3/room4 0 64 $(z)

# ===== 传送玩家到梯子位置 =====
function stardew:mine/floor/theme3/room4/teleport with storage stardew:mine room

# ===== 生成出口梯子 (X=6, Z+3) =====
function stardew:mine/floor/theme3/room4/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme3/room4/spawn_elevator with storage stardew:mine room

# ===== 生成矿石 (使用统一的矿石生成系统) =====
# 矿物区域: X:4~26 (30格房间，左右各留2格), Z:z+5~z+17 (前后各留2-3格)
...
scoreboard players operation #room_z_max sd_mine_temp = #z17 sd_mine_temp
