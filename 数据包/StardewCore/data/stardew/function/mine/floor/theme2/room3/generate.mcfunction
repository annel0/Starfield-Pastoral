# stardew:mine/floor/theme2/room3/generate.mcfunction
# 生成 theme2/room3 (40x5x40) - 冰川主题
# 参数: $(z), $(z6)
# 玩家出生/梯子: X=3, Z=z+4, 电梯: X=3, Z=z+2
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme2/room3 0 64 $(z)

# ===== 传送玩家（面朝东）=====
function stardew:mine/floor/theme2/room3/teleport with storage stardew:mine room

# ===== 生成出口梯子 =====
function stardew:mine/floor/theme2/room3/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme2/room3/spawn_elevator with storage stardew:mine room
