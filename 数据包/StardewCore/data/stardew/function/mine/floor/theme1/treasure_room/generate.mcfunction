# stardew:mine/floor/theme1/treasure_room/generate.mcfunction
# 生成 theme1 宝藏房间 (30x6x40) - 仅在第25层出现
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme1/treasure_room 0 64 $(z)
...
$execute in stardew:mine positioned 14 65 $(z) positioned ~ ~ ~12 run setblock ~ ~ ~ minecraft:chest[facing=south]{LootTable:"stardew:mining/treasure_room/theme1"}

# ===== 生成钓鱼区标记 (X=14, Z+27) =====
$execute in stardew:mine positioned 14 65 $(z) positioned ~ ~ ~27 run summon minecraft:marker ~ ~ ~ {Tags:["sd_fishing_spot","sd_mine_entity","sd_mine_theme1"]}
