# stardew:mine/floor/theme1/room2/generate.mcfunction
# 生成 theme1/room2 (30x5x40)
# 参数: $(z), $(z4), $(z5), $(z6)
# 梯子: X=6, Z=z+3, 电梯: X=7, Z=z+3, 玩家出生: X=7, Z=z+4
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme1/room2 0 64 $(z)

# ===== 传送玩家 =====
$execute in stardew:mine run tp @s 7 65 $(z4) 180 0

# ===== 生成出口梯子 =====
function stardew:mine/floor/theme1/room2/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme1/room2/spawn_elevator with storage stardew:mine room
