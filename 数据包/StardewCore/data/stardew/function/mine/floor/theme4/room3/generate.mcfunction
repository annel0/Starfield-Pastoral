# stardew:mine/floor/theme4/room3/generate.mcfunction
# 生成 theme4 room3 (30x5x30)
# 参数: $(z)
# 梯子: X=5 Z+3, 电梯: X=7 Z+3
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme4/room3 0 64 $(z)

# ===== 传送玩家到梯子位置 =====
function stardew:mine/floor/theme4/room3/teleport with storage stardew:mine room

# ===== 生成出口梯子 (X=5, Z+3) =====
function stardew:mine/floor/theme4/room3/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme4/room3/spawn_elevator with storage stardew:mine room
