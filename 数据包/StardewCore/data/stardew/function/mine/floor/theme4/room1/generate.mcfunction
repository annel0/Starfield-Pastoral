# stardew:mine/floor/theme4/room1/generate.mcfunction
# 生成 theme4 room1 (40x5x40)
# 参数: $(z)
...
# ===== 放置结构 =====
$execute in stardew:mine run place template stardew:mine/theme4/room1 0 64 $(z)

# ===== 传送玩家到梯子位置 =====
function stardew:mine/floor/theme4/room1/teleport with storage stardew:mine room

# ===== 生成出口梯子 (X=19, Z+2) =====
function stardew:mine/floor/theme4/room1/spawn_exit with storage stardew:mine room
...
execute if score #check_elevator sd_mine_temp matches 0 run function stardew:mine/floor/theme4/room1/spawn_elevator with storage stardew:mine room
