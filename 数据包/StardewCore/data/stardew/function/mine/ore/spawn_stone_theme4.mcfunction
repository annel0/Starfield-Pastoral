# stardew:mine/ore/spawn_stone_theme4.mcfunction
# 生成 theme4 的石头 (CMD 7204)
# 执行位置: 要生成矿石的位置

data modify storage stardew:macro_args args set value {stone_type:"stone",stone_hp:10,required_pickaxe_tier:1,ore_drop_type:"resource",model_cmd:7204,name:"石头(主题4)"}
