# stardew:mine/ore/spawn_earth_crystal.mcfunction
# 生成地晶矿

data modify storage stardew:macro_args args set value {stone_type:"earth_crystal",stone_hp:25,required_pickaxe_tier:2,ore_drop_type:"gem",model_cmd:7226,name:"地晶矿"}
