# stardew:mine/ore/spawn_quartz.mcfunction
# 生成石英矿

data modify storage stardew:macro_args args set value {stone_type:"quartz",stone_hp:25,required_pickaxe_tier:2,ore_drop_type:"gem",model_cmd:7225,name:"石英矿"}
