	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		...
		if (acceptLeftQuestButton.visible && acceptLeftQuestButton.containsPoint(x, y))
		{
			...
			if (leftOrder != null)
			{
				...
				Game1.player.team.AddSpecialOrder(order.questKey.Value, order.generationSeed.Value);
		...
		else if (acceptRightQuestButton.visible && acceptRightQuestButton.containsPoint(x, y))
		{
			...
			if (rightOrder != null)
			{
				...
				Game1.player.team.AddSpecialOrder(order2.questKey.Value, order2.generationSeed.Value);
