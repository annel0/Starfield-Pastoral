...
public class PondQueryMenu : IClickableMenu
{
	...
	{
		Random r = Utility.CreateDaySaveRandom(_pond.seedOffset.Value);
	...
	public override void draw(SpriteBatch b)
	{
		if (!Game1.globalFade)
		{
			...
			bool has_unresolved_needs = _pond.neededItem.Value != null && _pond.HasUnresolvedNeeds() && !_pond.hasCompletedRequest.Value;
			...
			Utility.drawTextWithShadow(b, population_text, Game1.smallFont, new Vector2(_pond.goldenAnimalCracker.Value ? ((float)(xPositionOnScreen + IClickableMenu.borderWidth + 4)) : ((float)(xPositionOnScreen + width / 2) - text_size.X * 0.5f), yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 + 128), Game1.textColor);
			int slots_to_draw = _pond.maxOccupants.Value;
