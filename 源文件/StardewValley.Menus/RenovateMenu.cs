		...
		if (_buildAnimationCount > 0)
		{
			...
			if (_renovation.animationType == HouseRenovation.AnimationType.Destroy)
			{
				...
				for (int i = 0; i < 5; i++)
				{
					...
					_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(x, y), flicker: false, Game1.random.NextBool()));
					_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(x, y), flicker: false, Game1.random.NextBool()));
					_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), new Vector2(x, y), flipped: false, 0f, Color.White)
					{
						interval = 30f,
			...
			else
			{
				...
				for (int j = 0; j < 20; j++)
				{
					...
					_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90) - 64, 6, 1, new Vector2(x2, y2), flicker: false, Game1.random.NextBool()));
					_renovation.location.temporarySprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90) - 64, 6, 1, new Vector2(x2, y2), flicker: false, Game1.random.NextBool()));
				}
			}
		}
