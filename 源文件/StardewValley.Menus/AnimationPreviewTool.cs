...
public class AnimationPreviewTool : IClickableMenu
{
	...
	private void RepositionElements()
	{
		...
		{
			int size_difference2 = scrollView.Right - Game1.graphics.GraphicsDevice.ScissorRectangle.Right;
		...
		{
			int size_difference4 = scrollView.Bottom - Game1.graphics.GraphicsDevice.ScissorRectangle.Bottom;
		...
		foreach (List<ClickableTextureComponent> component3 in components)
		{
			foreach (ClickableTextureComponent component2 in component3)
			{
				if (component2.containsPoint(x, y))
				{
					...
					{
					case "Shirt Style":
						SwitchShirt(component2.myID);
						break;
					case "Pants Style":
						SwitchPants(component2.myID);
						break;
					case "Hair Style":
						SwitchHair(component2.myID);
						break;
					case "Toggle Gender":
