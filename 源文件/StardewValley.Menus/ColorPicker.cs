...
public class ColorPicker
{
	...
	public void draw(SpriteBatch b)
	{
		...
		for (int k = 0; k < 24; k++)
		{
			Color c3 = HsvToRgb((double)hueBar.value / 100.0 * 360.0, (double)saturationBar.value / 100.0, (double)k / 24.0);
			b.Draw(Game1.staminaRect, new Rectangle(bounds.X + bounds.Width / 24 * k, bounds.Y + valueBar.bounds.Center.Y - 2, valueBar.bounds.Width / 24, 4), c3);
		}
