...
public class ResourceClump : TerrainFeature
{
	...
	public override bool performToolAction(Tool t, int damage, Vector2 tileLocation)
	{
		...
		Game1.createRadialDebris(Game1.currentLocation, radialDebris, (int)tileLocation.X + Game1.random.Next(width.Value / 2 + 1), (int)tileLocation.Y + Game1.random.Next(height.Value / 2 + 1), Game1.random.Next(4, 9), resource: false);
		if (health.Value <= 0f)
		{
