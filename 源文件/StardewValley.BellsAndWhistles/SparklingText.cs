...
public class SparklingText
{
	...
	public bool update(GameTime time)
	{
		...
		for (int i = 0; i < individualCharacterOffsets.Length; i++)
		{
			individualCharacterOffsets[i] = (float)((double)(amplitude / 2) * Math.Sin(Math.PI * 2.0 / (double)period * (double)(millisecondsDuration - i * 100)));
		}
