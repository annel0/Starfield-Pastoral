	...
	public override bool update(GameTime time, GameLocation environment)
	{
		...
		case 0:
			if (sprite.CurrentAnimation == null)
			{
				...
				{
					new FarmerSprite.AnimationFrame((short)baseFrame, 480),
					new FarmerSprite.AnimationFrame((short)(baseFrame + 1), 170, secondaryArm: false, flip),
					new FarmerSprite.AnimationFrame((short)(baseFrame + 2), 170, secondaryArm: false, flip)
				};
