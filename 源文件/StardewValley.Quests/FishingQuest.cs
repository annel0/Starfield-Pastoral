...
public class FishingQuest : Quest
{
	...
	public void loadQuestInfo()
	{
		...
		else
		{
			...
			parts.Clear();
			parts.Add(isSquid ? new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13248", reward.Value, numberToFish.Value, new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13253")) : new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13248", reward.Value, numberToFish.Value, fish2));
			dialogueparts.Clear();
			dialogueparts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13256", fish2));
			...
			objective.Value = (isSquid ? new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13255", 0, numberToFish.Value) : new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13244", 0, numberToFish.Value, fish2));
		}
