...
public class ItemDeliveryQuest : Quest
{
	...
	public void loadQuestInfo()
	{
		...
		target.Value = actualTarget.name.Value;
				...
				if (random.NextBool())
				{
					...
					if (obj != null && obj.Edibility > 0)
					{
						...
						else
						{
							...
							parts.Add(questDescriptions[rand2]);
							parts.Add(questDescriptions2[rand2]);
							parts.Add(questDescriptions3[rand2]);
						}
						switch (target.Value)
						{
						case "Demetrius":
		...
		case "Maru":
		{
			...
			parts.Clear();
			parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand5 ? "13580" : "13583"), item));
			dialogueparts.Clear();
			dialogueparts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand5 ? "13585" : "13587")));
			break;
		}
		case "Abigail":
		{
			...
			parts.Clear();
			parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand4 ? "13590" : "13593"), item));
			dialogueparts.Clear();
			dialogueparts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand4 ? "13597" : "13599")));
			break;
		}
		case "Sebastian":
			dialogueparts.Clear();
