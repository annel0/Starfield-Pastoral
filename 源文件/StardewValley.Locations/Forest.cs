...
public class Forest : GameLocation
{
	...
	public override void seasonUpdate(bool onLoad = false)
	{
		...
		{
			Microsoft.Xna.Framework.Rectangle area = MarnieLivestockArea;
			loadPathsLayerObjectsInArea(area.X, area.Y, area.Width, area.Height);
		}
	}
	...
	{
		if (!TryGetMapPropertyAs("TravelingCartPosition", out Point tile, false))
		{
	...
	{
		int tileIndexOfCheckLocation = getTileIndexAt(tileLocation, "Buildings", "outdoors");
