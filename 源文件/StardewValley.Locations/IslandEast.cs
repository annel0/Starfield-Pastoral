...
public class IslandEast : IslandForestLocation
{
	...
	public virtual void AddTorchLights()
	{
		...
		int torch_x = 1280;
		int torch_y = 704;
		temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1965, 8, 8), new Vector2(torch_x + 24, torch_y + 48), flipped: false, 0f, Color.White)
		{
			interval = 50f,
		...
		temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1984, 12, 12), new Vector2(torch_x + 16, torch_y + 28), flipped: false, 0f, Color.White)
		{
			interval = 50f,
			totalNumberOfLoops = 99999,
			animationLength = 4,
