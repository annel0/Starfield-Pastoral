...
public class IslandSouthEast : IslandLocation
{
	...
	public override void MakeMapModifications(bool force = false)
	{
		...
		if (IsRainingHere())
		{
			setMapTile(16, 27, 3, "Back", "untitled tile sheet3", "");
			setMapTile(18, 27, 4, "Back", "untitled tile sheet3", "");
			setMapTile(20, 27, 5, "Back", "untitled tile sheet3", "");
			setMapTile(22, 27, 6, "Back", "untitled tile sheet3", "");
			setMapTile(24, 27, 7, "Back", "untitled tile sheet3", "");
			setMapTile(26, 27, 8, "Back", "untitled tile sheet3", "");
		}
		else
		{
			setMapTile(16, 27, 39, "Back", "untitled tile sheet", "");
			setMapTile(18, 27, 39, "Back", "untitled tile sheet", "");
			setMapTile(20, 27, 39, "Back", "untitled tile sheet", "");
			setMapTile(22, 27, 39, "Back", "untitled tile sheet", "");
			setMapTile(24, 27, 39, "Back", "untitled tile sheet", "");
			setMapTile(26, 27, 39, "Back", "untitled tile sheet", "");
		}
		if (IslandSouthEastCave.isPirateNight())
		{
			setMapTile(29, 18, 36, "Buildings", "untitled tile sheet3");
			setTileProperty(29, 18, "Buildings", "Passable", "T");
			setMapTile(29, 19, 68, "Buildings", "untitled tile sheet3");
			setTileProperty(29, 19, "Buildings", "Passable", "T");
			setMapTile(30, 18, 99, "Buildings", "untitled tile sheet3");
			setTileProperty(30, 18, "Buildings", "Passable", "T");
			setMapTile(30, 19, 131, "Buildings", "untitled tile sheet3");
			setTileProperty(30, 19, "Buildings", "Passable", "T");
		}
		else
		{
			setMapTile(29, 18, 35, "Buildings", "untitled tile sheet3");
			setTileProperty(29, 18, "Buildings", "Passable", "T");
			setMapTile(29, 19, 67, "Buildings", "untitled tile sheet3");
			setTileProperty(29, 19, "Buildings", "Passable", "T");
			setMapTile(30, 18, 35, "Buildings", "untitled tile sheet3");
			setTileProperty(30, 18, "Buildings", "Passable", "T");
			setMapTile(30, 19, 67, "Buildings", "untitled tile sheet3");
			setTileProperty(30, 19, "Buildings", "Passable", "T");
		}
	}
	...
	protected override void resetLocalState()
	{
		...
		if (IslandSouthEastCave.isPirateNight())
		{
			...
			if (!hasLightSource("IslandSouthEast"))
			{
				sharedLights.AddLight(new LightSource("IslandSouthEast", 1, new Vector2(30.5f, 18.5f) * 64f, 4f, LightSource.LightContext.None, 0L, base.NameOrUniqueName));
			}
		}
	...
	{
		removeLightSource("IslandSouthEast");
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		if (!fishedWalnut.Value && Game1.random.NextDouble() < 0.005)
		{
