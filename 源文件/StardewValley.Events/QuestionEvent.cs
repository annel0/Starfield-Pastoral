...
public class QuestionEvent : BaseFarmEvent
{
	...
	public override bool setUp()
	{
		...
		case 1:
		{
			...
			NPC spouse2 = Game1.RequireCharacter(Game1.player.spouse);
			string dialogueKey = ((!spouse2.isAdoptionSpouse()) ? "Strings\\Events:HaveBabyQuestion" : "Strings\\Events:HaveBabyQuestion_Adoption");
			Game1.currentLocation.createQuestionDialogue(Game1.content.LoadString(dialogueKey, Game1.player.Name), answers2, answerPregnancyQuestion, spouse2);
