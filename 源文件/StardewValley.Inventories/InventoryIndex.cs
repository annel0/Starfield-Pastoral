...
public class InventoryIndex
{
	...
	{
		InventoryIndex instance = new InventoryIndex(delegate(InventoryIndex index, Item item2)
		{
			index.AddWithKey(item2.QualifiedItemId, item2);
		}, delegate(InventoryIndex index, Item item2)
		{
			index.RemoveItem(item2.QualifiedItemId, item2);
		});
