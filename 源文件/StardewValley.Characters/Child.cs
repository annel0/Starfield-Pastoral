...
public class Child : NPC
{
	...
	public override void reloadSprite(bool onlyAppearance = false)
	{
		...
		{
			Farmer parent = Game1.GetPlayer(idOfParent.Value);
	...
	public override void dayUpdate(int dayOfMonth)
	{
		...
		if (base.Age == 3)
		{
			...
			{
				p2 = (base.currentLocation as FarmHouse).GetChildBedSpot(GetChildIndex());
				if (!p2.Equals(Point.Zero))
				{
					setTilePosition(p2);
				}
	...
	public void tenMinuteUpdate()
	{
		...
		else
		{
			...
			{
				controller = new PathFindController(this, farmHouse2, bed_point, -1, toddlerReachedDestination);
