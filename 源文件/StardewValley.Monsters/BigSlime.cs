...
public class BigSlime : Monster
{
	...
	{
		base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(44, base.Position, c.Value, 10, flipped: false, 70f));
		base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(44, base.Position + new Vector2(-32f, 0f), c.Value, 10, flipped: false, 70f)
		{
	...
	public override void draw(SpriteBatch b)
	{
		if (!base.IsInvisible && Utility.isOnScreen(base.Position, 128))
		{
			...
			heldItem.Value?.drawInMenu(b, getLocalPosition(Game1.viewport) + new Vector2(28f, -16f + (float)Math.Sin(heldObjectBobTimer + 1f) * 4f), 1f, 1f, (float)(standingY - 1) / 10000f, StackDrawType.Hide, Color.White, drawShadow: false);
