...
public class Skeleton : Monster
{
	...
	{
		Sprite = new AnimatedSprite("Characters\\Monsters\\Skeleton" + (isMage.Value ? " Mage" : ""));
		Sprite.SpriteHeight = 32;
		Sprite.UpdateSourceRect();
	}
	...
	public override void shedChunks(int number)
	{
		...
		Game1.createRadialDebris(base.currentLocation, Sprite.textureName.Value, new Rectangle(0, 128, 16, 16), 8, standingPixel.X, standingPixel.Y, number, base.TilePoint.Y, Color.White, 4f);
	}
	...
	protected override void sharedDeathAnimation()
	{
		...
		shedChunks(20);
		Game1.createRadialDebris(base.currentLocation, Sprite.textureName.Value, new Rectangle(3, Game1.random.Choose(3, 35), 10, 10), 11, standingPixel.X, standingPixel.Y, 1, base.TilePoint.Y, Color.White, 4f);
	}
	...
	public override void behaviorAtGameTick(GameTime time)
	{
		...
		else if (spottedPlayer && controller == null && Game1.random.NextDouble() < (isMage.Value ? 0.009 : 0.003) && !base.wildernessFarmMonster && Utility.doesPointHaveLineOfSightInMine(base.currentLocation, base.Tile, base.Player.Tile, 8))
		{
			throwing.Value = true;
			Halt();
