...
public class Monster : NPC
{
	...
	public override void update(GameTime time, GameLocation location)
	{
		...
		if (!isGlider.Value && (base.Position.X < 0f || base.Position.X > (float)(backLayer.LayerWidth * 64) || base.Position.Y < 0f || base.Position.Y > (float)(backLayer.LayerHeight * 64)))
		{
	...
	public override void MovePosition(GameTime time, xTile.Dimensions.Rectangle viewport, GameLocation currentLocation)
	{
		...
		if (xVelocity != 0f || yVelocity != 0f)
		{
			...
			if (!isGlider.Value || isGroundedGlider)
			{
			...
			for (int i = 1; i <= steps; i++)
			{
				...
				bool isGliderForCollisions = isGlider.Value && !isGroundedGlider;
				if (currentLocation != null && currentLocation.isCollidingPosition(nextPosition, viewport, isFarmer: false, DamageToFarmer, isGliderForCollisions, this))
				{
		...
		if (moveUp)
		{
			if (((!Game1.eventUp || Game1.IsMultiplayer) && !currentLocation.isCollidingPosition(this.nextPosition(0), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this)) || isCharging)
			{
			...
			else
			{
				...
				tmp.Width /= 4;
				bool leftCorner = currentLocation.isCollidingPosition(tmp, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				tmp.X += tmp.Width * 3;
				bool rightCorner = currentLocation.isCollidingPosition(tmp, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				if (leftCorner && !rightCorner && !currentLocation.isCollidingPosition(this.nextPosition(1), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.X += (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
				else if (rightCorner && !leftCorner && !currentLocation.isCollidingPosition(this.nextPosition(3), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.X -= (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
		...
		{
			if (((!Game1.eventUp || Game1.IsMultiplayer) && !currentLocation.isCollidingPosition(this.nextPosition(1), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this)) || isCharging)
			{
			...
			else
			{
				...
				tmp2.Height /= 4;
				bool topCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				tmp2.Y += tmp2.Height * 3;
				bool bottomCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				if (topCorner && !bottomCorner && !currentLocation.isCollidingPosition(this.nextPosition(2), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.Y += (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
				else if (bottomCorner && !topCorner && !currentLocation.isCollidingPosition(this.nextPosition(0), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.Y -= (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
		...
		{
			if (((!Game1.eventUp || Game1.IsMultiplayer) && !currentLocation.isCollidingPosition(this.nextPosition(2), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this)) || isCharging)
			{
				position.Y += (float)base.speed + addedSpeed;
				if (!ignoreMovementAnimations)
				{
			...
			else
			{
				...
				tmp3.Width /= 4;
				bool leftCorner2 = currentLocation.isCollidingPosition(tmp3, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				tmp3.X += tmp3.Width * 3;
				bool rightCorner2 = currentLocation.isCollidingPosition(tmp3, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				if (leftCorner2 && !rightCorner2 && !currentLocation.isCollidingPosition(this.nextPosition(1), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.X += (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
				else if (rightCorner2 && !leftCorner2 && !currentLocation.isCollidingPosition(this.nextPosition(3), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.X -= (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
		...
		{
			if (((!Game1.eventUp || Game1.IsMultiplayer) && !currentLocation.isCollidingPosition(this.nextPosition(3), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this)) || isCharging)
			{
				position.X -= (float)base.speed + addedSpeed;
				FacingDirection = 3;
				if (!ignoreMovementAnimations)
			...
			else
			{
				...
				tmp4.Height /= 4;
				bool topCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				tmp4.Y += tmp4.Height * 3;
				bool bottomCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
				if (topCorner2 && !bottomCorner2 && !currentLocation.isCollidingPosition(this.nextPosition(2), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.Y += (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
				else if (bottomCorner2 && !topCorner2 && !currentLocation.isCollidingPosition(this.nextPosition(0), viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this))
				{
					position.Y -= (float)base.speed * ((float)time.ElapsedGameTime.Milliseconds / 64f);
				}
