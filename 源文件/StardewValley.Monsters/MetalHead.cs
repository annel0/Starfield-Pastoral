...
public class MetalHead : Monster
{
	...
	public override void shedChunks(int number, float scale)
	{
		...
		Game1.createRadialDebris(base.currentLocation, Sprite.textureName.Value, new Rectangle(0, Sprite.getHeight() * 4, 16, 16), 8, standingPixel.X, standingPixel.Y, number, base.TilePoint.Y, Color.White, scale * 4f);
	}
