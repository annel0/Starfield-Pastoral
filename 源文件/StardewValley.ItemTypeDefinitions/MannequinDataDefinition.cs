...
public class MannequinDataDefinition : BaseItemDataDefinition
{
	...
	public override ParsedItemData GetData(string itemId)
	{
		...
		return new ParsedItemData(this, itemId, data.SheetIndex, data.Texture ?? "TileSheets/Mannequins", itemId, TokenParser.ParseText(data.DisplayName), TokenParser.ParseText(data.Description), -24, null, null);
	}
