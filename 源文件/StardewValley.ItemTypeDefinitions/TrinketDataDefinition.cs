...
public class TrinketDataDefinition : BaseItemDataDefinition
{
	...
	public override ParsedItemData GetData(string itemId)
	{
		...
		return new ParsedItemData(this, itemId, data.SheetIndex, data.Texture, itemId, TokenParser.ParseText(data.DisplayName), TokenParser.ParseText(data.Description), -101, null, null);
	}
