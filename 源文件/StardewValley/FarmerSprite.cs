...
public class FarmerSprite : AnimatedSprite
{
	...
	{
		bool carrying = owner?.IsCarrying() ?? false;
		...
		if (timer > interval * intervalModifier)
		{
			...
			if (currentAnimationIndex > currentAnimationFrames - 1)
			{
				...
				if (endOfAnimationFunction != null)
				{
					...
					if (!(owner.CurrentTool is MeleeWeapon weapon) || weapon.type.Value != 1)
					{
						doneWithAnimation();
					}
					return;
	...
	private void checkForFootstep()
	{
		...
		if (((currentSingleAnimation >= 32 && currentSingleAnimation <= 56) || (currentSingleAnimation >= 128 && currentSingleAnimation <= 152)) && currentAnimationIndex % 4 == 0)
		{
			...
			if (played_step != null && owner.currentLocation == Game1.currentLocation && Utility.isOnScreen(owner.Position, 384) && (owner == Game1.player || !LocalMultiplayer.IsLocalMultiplayer(is_local_only: true)))
			{
	...
	public virtual void getAnimationFromIndex(int index, FarmerSprite requester, int interval, int numberOfFrames, bool flip, bool secondaryArm)
	{
		...
		bool inBathingClothes = requester.owner?.bathingClothes.Value ?? false;
		switch (index)
		{
		case -1:
		...
		case 0:
		case 96:
			outFrames.Add(new AnimationFrame(1 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(2 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			return;
		case 8:
		case 104:
			outFrames.Add(new AnimationFrame(7 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(6 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(8 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(6 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			return;
		case 16:
		case 112:
			outFrames.Add(new AnimationFrame(13 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(12 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(14 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			outFrames.Add(new AnimationFrame(12 + frameOffset, 200, showCarryingArm, flip: false, inBathingClothes));
			return;
		case 24:
		case 120:
			outFrames.Add(new AnimationFrame(7 + frameOffset, 200, showCarryingArm, flip: true, inBathingClothes));
			outFrames.Add(new AnimationFrame(6 + frameOffset, 200, showCarryingArm, flip: true, inBathingClothes));
			outFrames.Add(new AnimationFrame(8 + frameOffset, 200, showCarryingArm, flip: true, inBathingClothes));
			outFrames.Add(new AnimationFrame(6 + frameOffset, 200, showCarryingArm, flip: true, inBathingClothes));
			return;
		case 32:
		case 128:
		...
		case 232:
			...
			outFrames.Add(new AnimationFrame(24, 55, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(25, 45, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(26, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(27, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(28, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(29, (short)interval * 2, showCarryingArm, flip: false, owner.showSwordSwipe));
		...
		case 160:
			...
			outFrames.Add(new AnimationFrame(69, (short)((float)(170 + requester.owner.toolPower.Value * 30) * toolSpeedModifier), secondaryArm: false, flip: false));
		...
		case 240:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(30, 55, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(31, 45, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(32, 25, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(33, 25, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(34, 25, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(35, (short)interval * 2, secondaryArm: true, flip: false, owner.showSwordSwipe));
		...
		case 168:
			...
			outFrames.Add(new AnimationFrame(51, (short)((float)(220 + requester.owner.toolPower.Value * 30) * toolSpeedModifier), secondaryArm: false, flip: false));
		...
		case 248:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(36, 55, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(37, 45, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(38, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(39, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(40, 25, showCarryingArm, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(41, (short)interval * 2, showCarryingArm, flip: false, owner.showSwordSwipe));
		...
		case 176:
			...
			outFrames.Add(new AnimationFrame(63, (short)((float)(220 + requester.owner.toolPower.Value * 30) * toolSpeedModifier), secondaryArm: false, flip: false));
		...
		case 256:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(30, 55, secondaryArm: true, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(31, 45, secondaryArm: true, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(32, 25, secondaryArm: true, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(33, 25, secondaryArm: true, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(34, 25, secondaryArm: true, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(35, (short)interval * 2, secondaryArm: true, flip: true, owner.showSwordSwipe));
		...
		case 184:
			...
			outFrames.Add(new AnimationFrame(51, (short)((float)(220 + requester.owner.toolPower.Value * 30) * toolSpeedModifier), secondaryArm: false, flip: true));
		...
		case 272:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(25, (short)interval, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(27, (short)interval, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(27, 0, secondaryArm: true, flip: false, Farmer.canMoveNow, behaviorAtEndOfFrame: true));
			return;
		case 274:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(34, (short)interval, secondaryArm: false, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(33, (short)interval, secondaryArm: false, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(33, 0, secondaryArm: false, flip: false, Farmer.canMoveNow, behaviorAtEndOfFrame: true));
			return;
		case 276:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(40, (short)interval, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(38, (short)interval, secondaryArm: true, flip: false, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(38, 0, secondaryArm: true, flip: false, Farmer.canMoveNow, behaviorAtEndOfFrame: true));
			return;
		case 278:
			requester.loopThisAnimation = false;
			outFrames.Add(new AnimationFrame(34, (short)interval, secondaryArm: false, flip: true, owner.showSwordSwipe));
			outFrames.Add(new AnimationFrame(33, (short)interval, secondaryArm: false, flip: true, owner.showSwordSwipe));
