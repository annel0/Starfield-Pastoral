...
public abstract class Tool : Item
{
	...
	protected override void GetOneCopyFrom(Item source)
	{
		...
		if (source is Tool fromTool)
		{
			...
			Name = source.Name;
			CurrentParentTileIndex = fromTool.CurrentParentTileIndex;
			IndexOfMenuItemView = fromTool.IndexOfMenuItemView;
			InstantUse = fromTool.InstantUse;
			IsEfficient = fromTool.IsEfficient;
			AnimationSpeedModifier = fromTool.AnimationSpeedModifier;
	...
	public virtual void draw(SpriteBatch b)
	{
		...
		foreach (Vector2 v in tilesAffected(lastUser.GetToolLocation() / 64f, lastUser.toolPower.Value, lastUser))
		{
	...
	protected override int getDescriptionWidth()
	{
		...
		foreach (BaseEnchantment e in enchantments)
		{
