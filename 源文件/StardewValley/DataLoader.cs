...
public static class DataLoader
{
	...
	/// <summary>Load the <c>Data/LostItemsShop</c> asset.</summary>
	/// <param name="content">The content manager through which to load data.</param>
	...
	/// <param name="content">The content manager through which to load data.</param>
	/// <remarks>Most code should use <see cref="M:StardewValley.Farmer.GetHairStyleMetadataFile" /> instead.</remarks>
	...
	/// <param name="content">The content manager through which to load data.</param>
	/// <remarks>Most code should use <see cref="F:StardewValley.Game1.locationData" /> instead.</remarks>
