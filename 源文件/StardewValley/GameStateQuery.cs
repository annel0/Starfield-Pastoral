...
public class GameStateQuery
{
	...
	public static class DefaultResolvers
	{
		...
		public static bool PLAYER_MOD_DATA(string[] query, GameStateQueryContext context)
		{
			...
			return Helpers.WithPlayer(context.Player, playerKey, (Farmer target) => target.modData.TryGetValue(key, out var value2) && value2.EqualsIgnoreCase(value));
		}
		...
		public static bool PLAYER_SHIPPED_BASIC_ITEM(string[] query, GameStateQueryContext context)
		{
			...
			return Helpers.WithPlayer(context.Player, playerKey, (Farmer target) => target.basicShipped.TryGetValue(itemId, out var value) && value >= minShipped && value <= maxShipped);
		}
