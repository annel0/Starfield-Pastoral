...
{
	public struct ButtonEnumerator(Buttons pressed)
	{
		private readonly Buttons _pressed = pressed;
		...
		public bool MoveNext()
		{
			...
			{
				_current++;
				if (((uint)_pressed & (uint)(1 << _current)) != 0)
				{
					return true;
				}
			}
	...
	private readonly Buttons _pressed = (Buttons)0;
