...
public class Cask : Object
{
	...
	public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
	{
		...
		if (value != null && value.quality.Value > 0)
		{
			...
			spriteBatch.Draw(Game1.mouseCursors, destination, (heldObject.Value.quality.Value < 4) ? new Rectangle(338 + (heldObject.Value.quality.Value - 1) * 8, 400, 8, 8) : new Rectangle(346, 392, 8, 8), Color.White * 0.95f, 0f, Vector2.Zero, SpriteEffects.None, (float)((y + 1) * 64) / 10000f);
		}
	}
}
