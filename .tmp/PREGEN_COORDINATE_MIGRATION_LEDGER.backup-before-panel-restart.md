...
| oasis_indoor_exit_portal | Oasis 室内出口触发区 | 18241 | 71 | 17668 | -253..-251 | 30..32 | -146..-146 | 待测 | `DesertConstants.java` | 旧区域 size `1x2x1`；hint 由实际 PortalTrigger 方块区域自动生成。 min=(-253,30,-146), max=(-251,32,-146) |
...
| seedshop_outdoor_door | 通用：SeedShop | Pierre / 种子店 | -159.0 | -18.0 | 54.0 | 27..27 | 65..67 | -8..-8 | `12038.5,71.0,12038.5` | 待测 | `InteriorSubspaceManager.java`, 商店柜台判定 | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(27,65,-8), max=(27,67,-8) |
| manorhouse_outdoor_door | 通用：ManorHouse | 镇长家 | -197.0 | -17.0 | -22.0 | 50..51 | 66..67 | 34..34 | `14786.5,71.0,14789.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(50,66,34), max=(51,67,34) |
| saloon_outdoor_door | 通用：Saloon | 酒吧 | -164.0 | -17.0 | 15.0 | 29..30 | 66..67 | 14..14 | `14210.5,71.0,14225.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(29,66,14), max=(30,67,14) |
| blacksmith_outdoor_door | 通用：Blacksmith | 铁匠铺 | -288.0 | -18.0 | -17.0 | 108..108 | 64..65 | 29..29 | `13635.5,71.0,13640.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(108,64,29), max=(108,65,29) |
| museum_outdoor_door | 通用：Museum | 博物馆 | -309.0 | -17.0 | -36.0 | 124..124 | 64..65 | 42..42 | `13066.5,71.0,13061.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(124,64,42), max=(124,65,42) |
| clinic_outdoor_door | 通用：Clinic | 诊所 | -146.0 | -18.0 | 60.0 | 13..13 | 65..66 | -8..-8 | `15362.5,71.0,15371.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(13,65,-8), max=(13,66,-8) |
| riverroad1_outdoor_door | 通用：JoshHouse | 1 River Road / Alex 家 | -195.0 | -18.0 | 32.0 | 48..48 | 64..65 | 1..1 | `15939.5,71.0,15948.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(48,64,1), max=(48,65,1) |
| sciencehouse_outdoor_door | 通用：ScienceHouse | 木匠家 / Robin 家 | -213.0 | -12.0 | 219.0 | 28..29 | 85..86 | -115..-115 | `16525.5,75.0,16519.5` | 待测 | `InteriorSubspaceManager.java` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(28,85,-115), max=(29,86,-115) |
| samhouse_outdoor_door | 通用：SamHouse | 1 Willow Lane / Sam 家 | -85.0 | -16.0 | -25.0 | -29..-28 | 65..66 | 39..39 | `17090.5,71.0,17093.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(-29,65,39), max=(-28,66,39) |
| haleyhouse_outdoor_door | 通用：HaleyHouse | 2 Willow Lane / Haley 家 | -115.0 | -17.0 | -27.0 | -11..-10 | 64..65 | 39..39 | `17092.5,71.0,17666.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(-11,64,39), max=(-10,65,39) |
| animalshop_outdoor_door | 通用：AnimalShop | Marnie 牧场 | 178.0 | -14.0 | -4.0 | -92..-91 | 64..65 | 21..21 | `17090.5,71.0,18255.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(-92,64,21), max=(-91,65,21) |
| leahhouse_outdoor_door | 通用：LeahHouse | Leah 小屋 | 155.0 | -13.0 | -58.0 | -83..-82 | 64..64 | 52..52 | `17094.5,71.0,18823.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(-83,64,52), max=(-82,64,52) |
| adventurer_guild_outdoor_door | 通用：AdventurerGuild | 冒险者公会 | -335.0 | -13.0 | 312.0 | 106..106 | 81..82 | -142..-142 | `17664.5,71.0,17088.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(106,81,-142), max=(106,82,-142) |
| fishshop_outer | 通用：FishShop | 鱼店 / Willy 店 | -237.0 | -15.0 | -212.0 | 64..65 | 60..61 | 150..150 | `17665,71,17670` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域；录入时统一门区和 NPC anchor。 min=(64,60,150), max=(65,61,150) |
| elliott_cabin_outdoor_door | 通用：ElliottHouse | Elliott 小屋 | -267.0 | -13.0 | -152.0 | 80..81 | 60..61 | 101..101 | `17666.5,71.0,18243.5` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(80,60,101), max=(81,61,101) |
| wizard_tower_outdoor_door | 通用：WizardTower | 法师塔外门/星露谷入口 | 340.0 | -1.0 | -42.0 | -179..-179 | 69..70 | 50..50 | `18249.5,71.0,17095.5` | 待测 | `InteriorSubspaceManager.java`, `CrossDimensionTeleporter.java`, `base_locations.json`, wizard 过场 | portal 触发区；hint 自动跟随 PortalTrigger 方块区域；还要核对 overworld 法师塔往返。 min=(-179,69,50), max=(-179,70,50) |
| joja_mart_outdoor_door | 通用：JojaMart | Joja Mart | -294.0 | -16.0 | 59.0 | 108..109 | 65..66 | -17..-17 | `18241,71,18253` | 待测 | `InteriorSubspaceManager.java`, `base_locations.json` | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(108,65,-17), max=(109,66,-17) |
...
| communitycenter_outer | 通用：CommunityCenter | 社区中心 | -190.0 | -10.0 | 138.0 | 54..54 | 67..68 | -49..-49 | `18833,70,18853` | 待测 | `InteriorSubspaceManager.java`, 社区中心奖励/过场 | portal 触发区；hint 自动跟随 PortalTrigger 方块区域。 min=(54,67,-49), max=(54,68,-49) |
...
| pam_saloon_seat | Pam | Pam 酒吧常驻座位 | 14216.5 | 71 | 14233.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pam 酒吧常驻座位；indoor=true |
| pam_busstop_bench | Pam | Pam 公交站等车点（朝北） | 69 | -12 | 207 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pam 公交站等车点（朝北） |
| pam_town_walk | Pam | Pam 镇上闲逛（朝南） | -37 | -16 | 59 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pam 镇上闲逛（朝南） |
| penny_trailer_sleep | Penny | Penny 拖车睡觉位 | -233 | -18 | 20 |  |  |  | 0 北/N | 待测 | `npc/events/npc_route_points.json` | 拖车统一地图室内点；由 MD 录入，应用后写入 `indoor=true`。 |
| penny_trailer_kitchen | Penny | Penny 拖车厨房停留点 | -233 | -18 | 20 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | 拖车统一地图室内点；由 MD 录入，应用后写入 `indoor=true`。 |
| penny_trailer_reading | Penny | Penny 拖车阅读位 | -233 | -18 | 20 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | 拖车统一地图室内点；由 MD 录入，应用后写入 `indoor=true`。 |
| penny_museum_tutor | Penny | Penny 博物馆授课位（朝西） | 13075.5 | 71 | 13076.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Penny 博物馆授课位（朝西）；indoor=true |
| penny_town_walk | Penny | Penny 镇上散步（朝北） | -272 | -18 | -28 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Penny 镇上散步（朝北） |
| penny_town_bench | Penny | Penny 镇上长椅 | -163 | -18 | -3 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Penny 镇上长椅 |
| pierre_seedshop_counter | Pierre | Pierre 种子店柜台 | 12051.5 | 71 | 12038.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pierre 种子店柜台；indoor=true |
...
| pierre_seedshop_living | Pierre | Pierre 种子店起居区（朝东） | 12042.5 | 71 | 12060.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Pierre 种子店起居区（朝东）；indoor=true |
| pierre_saloon_seat | Pierre | Pierre 酒吧座位（朝东） | 14217.5 | 71 | 14209.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pierre 酒吧座位（朝东）；indoor=true |
| pierre_town_walk | Pierre | Pierre 镇上散步（朝东） | -133 | -10 | 123 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Pierre 镇上散步（朝东） |
| robin_sciencehouse_counter | Robin | Robin 木匠店柜台（朝西） | 16530.5 | 75 | 16520.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Robin 木匠店柜台（朝西）；indoor=true |
...
| robin_sciencehouse_living | Robin | Robin 木匠店起居区（朝东） | 16540.5 | 77 | 16544.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Robin 木匠店起居区（朝东）；indoor=true |
| robin_saloon_seat | Robin | Robin 酒吧座位（朝西） | 14216.5 | 71 | 14253.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Robin 酒吧座位（朝西）；indoor=true |
| robin_town_walk | Robin | Robin 镇上散步（朝北） | -210 | -9 | 136 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Robin 镇上散步（朝北） |
| sam_samhouse_guitar | Sam | Sam 房间弹吉他（朝西） | 17100.5 | 71 | 17109.5 |  |  |  | 2 南/S; 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 房间弹吉他（朝西）；indoor=true |
| sam_samhouse_living | Sam | Sam 家客厅（朝南） | 17098.5 | 71 | 17090.5 |  |  |  | 0 北/N; 1 东/E; 2 南/S; 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 家客厅（朝南）；indoor=true |
| sam_samhouse_sleep | Sam | Sam 房间床（朝西） | 17101.5 | 71 | 17111.5 |  |  |  | 0 北/N; 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sam 房间床（朝西）；indoor=true |
| sam_museum_work | Sam | Sam 博物馆工作台（朝东） | 13065.5 | 71 | 13089.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Sam 博物馆工作台（朝东）；indoor=true |
| sam_town_skateboard | Sam | Sam 镇上玩滑板（朝北） | -95 | -16 | -27 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Sam 镇上玩滑板（朝北） |
| sam_town_walk | Sam | Sam 镇上散步（朝南） | -145 | -17 | 20 |  |  |  | 0 北/N; 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 镇上散步（朝南） |
| sam_saloon_pool | Sam | Sam 酒吧台球桌（朝南） | 14214.5 | 71 | 14251.5 |  |  |  | 0 北/N; 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 酒吧台球桌（朝南）；indoor=true |
| sam_beach_hangout | Sam | Sam 沙滩闲逛（朝南） | -279 | -14 | -163 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 沙滩闲逛（朝南） |
| sam_forest_walk | Sam | Sam 森林散步（朝北） | 243 | -13 | -23 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sam 森林散步（朝北） |
| sebastian_room_computer | Sebastian | Sebastian 房间电脑前（朝北） | 16519.5 | 71 | 16535.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sebastian 房间电脑前（朝北）；indoor=true |
| sebastian_room_desk | Sebastian | Sebastian 房间书桌（朝北） | 16515.5 | 71 | 16530.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sebastian 房间书桌（朝北）；indoor=true |
| sebastian_room_bed | Sebastian | Sebastian 房间床（朝北） | 16515.5 | 71 | 16535.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 房间床（朝北）；indoor=true |
| sebastian_saloon_pool | Sebastian | Sebastian 酒吧台球桌（朝北） | 14213.5 | 71 | 14255.5 |  |  |  | 0 北/N | 待测 | `npc/events/npc_route_points.json` | Sebastian 酒吧台球桌（朝北）；indoor=true |
| sebastian_town_walk | Sebastian | Sebastian 镇上散步（朝北） | -209 | -10 | 97 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 镇上散步（朝北） |
| sebastian_town_smoke | Sebastian | Sebastian 镇上抽烟（朝北） | -209 | -10 | 97 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 镇上抽烟（朝北） |
| sebastian_samhouse_keyboard | Sebastian | Sebastian 在Sam家弹键盘（朝西） | 17098.5 | 71 | 17109.5 |  |  |  | 0 北/N | 待测 | `npc/events/npc_route_points.json` | Sebastian 在Sam家弹键盘（朝西）；indoor=true |
| sebastian_samhouse_hangout | Sebastian | Sebastian 在Sam家闲逛（朝东） | 17096.5 | 71 | 17111.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 在Sam家闲逛（朝东）；indoor=true |
| sebastian_mountain_smoke | Sebastian | Sebastian 山上抽烟（朝南） | -252 | -5 | 176 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 山上抽烟（朝南） |
| sebastian_mountain_walk | Sebastian | Sebastian 山上散步（朝南） | -285 | -10 | 199 |  |  |  | 0 北/N; 2 南/S | 待测 | `npc/events/npc_route_points.json` | Sebastian 山上散步（朝南） |
| sebastian_mountain_cliff | Sebastian | Sebastian 山上悬崖边（朝北） | -312 | -15 | 261 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sebastian 山上悬崖边（朝北） |
| sebastian_sciencehouse_hall | Sebastian | Sebastian 科学屋走廊（朝南） | 16528.5 | 75 | 16514.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Sebastian 科学屋走廊（朝南）；indoor=true |
| shane_animalshop_room | Shane | Shane 房间（Marnie家） | 17104.5 | 71 | 18265.5 |  |  |  | 0 北/N; 3 西/W | 待测 | `npc/events/npc_route_points.json` | Shane 房间（Marnie家）；indoor=true |
| shane_animalshop_sleep | Shane | Shane 睡觉位置 | 17108.5 | 71 | 18273.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Shane 睡觉位置；indoor=true |
| shane_animalshop_outside | Shane | Shane Marnie家门外 | 156 | -13 | -18 |  |  |  | 1 东/E; 2 南/S | 待测 | `npc/events/npc_route_points.json` | Shane Marnie家门外 |
| shane_animalshop_chickens | Shane | Shane 看鸡（Marnie牧场旁） | 156 | -13 | -18 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Shane 看鸡（Marnie牧场旁） |
| shane_saloon_drink | Shane | Shane 酒吧喝酒位 | 14216.5 | 71 | 14218.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Shane 酒吧喝酒位；indoor=true |
| shane_saloon_seat | Shane | Shane 酒吧座位 | 14210.5 | 71 | 14252.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Shane 酒吧座位；indoor=true |
| shane_seedshop_browse | Shane | Shane 杂货店逛逛 | 12051.5 | 71 | 12043.5 |  |  |  | 0 北/N | 待测 | `npc/events/npc_route_points.json` | Shane 杂货店逛逛；indoor=true |
| vincent_samhouse_play | Vincent | Vincent Sam家玩耍 | 17091.5 | 71 | 17103.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Vincent Sam家玩耍；indoor=true |
| vincent_samhouse_kitchen | Vincent | Vincent Sam家厨房 | 17106.5 | 71 | 17090.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Vincent Sam家厨房；indoor=true |
| vincent_samhouse_sleep | Vincent | Vincent Sam家睡觉 | 17093.5 | 71 | 17099.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Vincent Sam家睡觉；indoor=true |
| vincent_town_playground | Vincent | Vincent 镇上游乐场 | -119 | -10 | 118 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Vincent 镇上游乐场 |
| vincent_town_walk | Vincent | Vincent 镇上散步 | -123 | -10 | 91 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Vincent 镇上散步 |
| vincent_beach_play | Vincent | Vincent 海滩玩耍 | -230 | -15 | -188 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Vincent 海滩玩耍 |
| vincent_museum_read | Vincent | Vincent 博物馆看书 | 13071.5 | 71 | 13075.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Vincent 博物馆看书；indoor=true |
| fishshop_outdoor_door | 通用：FishShop | 鱼店室外入口门点 | -237 | -15 | -212 |  |  |  | 未引用 | 待测 | `npc/events/npc_route_points.json` | 鱼店室外入口门点 |
| fishshop_indoor_entry | 通用：FishShop | 鱼店室内传送落点 | 17666.5 | 71 | 17670.5 |  |  |  | 未引用 | 待测 | `npc/events/npc_route_points.json` | 鱼店室内传送落点；indoor=true |
| willy_fishshop_counter | Willy | Willy 鱼店柜台 | 17670.5 | 71 | 17670.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Willy 鱼店柜台；indoor=true |
| willy_fishshop_room | Willy | Willy 鱼店卧室（暂同柜台） | 17670.5 | 71 | 17670.5 |  |  |  | 2 南/S | 待测 | `npc/events/npc_route_points.json` | Willy 鱼店卧室（暂同柜台）；indoor=true |
| willy_fishshop_sleep | Willy | Willy 鱼店睡觉（暂同柜台） | 17670.5 | 71 | 17670.5 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Willy 鱼店睡觉（暂同柜台）；indoor=true |
| willy_beach_fishing | Willy | Willy 海滩钓鱼位 | -229 | -15 | -220 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Willy 海滩钓鱼位 |
| willy_beach_evening | Willy | Willy 海滩傍晚位 | -260 | -15 | -220 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Willy 海滩傍晚位 |
| willy_saloon_seat | Willy | Willy 酒吧座位 | 14210.5 | 71 | 14233.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Willy 酒吧座位；indoor=true |
| willy_forest_walk | Willy | Willy 森林散步 | 217 | -13 | -67 |  |  |  | 1 东/E | 待测 | `npc/events/npc_route_points.json` | Willy 森林散步 |
| willy_town_bench | Willy | Willy 镇上长椅 | -167 | -18 | -5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Willy 镇上长椅 |
| gunther_counter | Gunther | Gunther 博物馆柜台 | 13074.5 | 71 | 13060.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Gunther 博物馆柜台；indoor=true |
| marlon_counter | Marlon | Marlon 冒险家公会柜台 | 17672.5 | 71 | 17093.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Marlon 冒险家公会柜台；indoor=true |
| wizard_home | Wizard | Wizard 法师塔内 | 18249.5 | 71 | 17095.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Wizard 法师塔内；indoor=true |
| sandy_oasis_counter | Sandy | Sandy 绿洲柜台工作位（朝西） | 18245.5 | 71 | 17666.5 |  |  |  | 3 西/W | 待测 | `npc/events/npc_route_points.json` | Sandy 绿洲柜台工作位（朝西）；indoor=true |
...
| coal_forest_bounds | 煤矿森林区域判定 | `x=129..207, y=-16..2, z=-246..-102` |  | 待测 | `CoalForestArea.java`, `CoalForestClumpSpawnService.java` |  |
...
| fishing_desert | 沙漠钓鱼 | fishing 数据 + 沙漠 biome/区域 |  | 待测 | `fishing/locations/desert.json`, `StardewBiomePatcher.java`, `DesertConstants.java` | 沙漠内嵌后，要确认沙漠水域/绿洲水域 biome。 |
| biome_patch_desert | 沙漠 biome patch 区域 | `DesertConstants.DESERT_BBOX_*` |  | 待测 | `StardewBiomePatcher.java`, `DesertConstants.java` | 影响沙漠鱼、天气、音乐、采集条件。 |
| community_center_unlocks | 社区中心修复区域 | 过场/奖励放置逻辑 |  | 待测 | `AreaCompletionService.java`, `CCAreaRegistry.java`, 社区中心过场 | 要验证每个修复区域、告示牌和奖励放置点。 |
| community_center_room_rects | 社区中心各房间修复矩形 | `CC_SCHEM_POS1=(-146,101,-1333)` 相关绝对坐标 |  | 待测 | `CCAreaRegistry.java`, `InteriorSubspaceManager.java` | 新地图内嵌后，旧 CC 大坐标/旧绝对注释都要重测。 |
| music_regions | 主地图/室内/沙漠音乐区域 | 旧室内大坐标 + 沙漠 bounds |  | 待测 | `StardewMusicManager.java` | 包含室内音乐、沙漠 outdoor 音乐、默认季节音乐切换。 |
