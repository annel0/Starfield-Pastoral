...
code_gizmo = """package com.stardew.craft.client.deco;
...
public final class DecorAnchorWorldGizmo {
    ...
    public static void onRenderLevel(PoseStack pose, MultiBufferSource.BufferSource buffers, Vec3 camPos) {
