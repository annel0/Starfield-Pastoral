package com.stardew.craft.item.tree.fruit;
...
public class FruitTreeSaplingItem extends StardewBlockItem {
    private final FruitTreeType type;
    private final Supplier<? extends Block> saplingBlock;

    public FruitTreeSaplingItem(FruitTreeType type, Supplier<? extends Block> saplingBlock, Properties properties) {
        super(saplingBlock.get(), "stardewcraft.type.seed", type.saplingSellPrice(), properties);
        this.type = type;
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!FruitTreeRules.canPlantSapling(level, placePos)) {
