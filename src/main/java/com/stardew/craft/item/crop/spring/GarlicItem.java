 ...
 * 蒜
 */
public class GarlicItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{40, 60, 75, 90};
    ...
    public GarlicItem(Item.Properties properties) {
        super(properties
