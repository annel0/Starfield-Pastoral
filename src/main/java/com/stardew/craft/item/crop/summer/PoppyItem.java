 ...
 * 虞美人花
 */
public class PoppyItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{140, 175, 210, 280};
    ...
    public PoppyItem(Item.Properties properties) {
        super(properties
    ...
    public InteractionResult useOn(UseOnContext context) {
        InteractionResult result = FlowerPlacement.place(context, ModBlocks.POPPY_CROP);
