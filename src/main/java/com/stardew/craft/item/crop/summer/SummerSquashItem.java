 ...
 * 金皮西葫芦
 */
public class SummerSquashItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{45, 56, 67, 90};
    ...
    public SummerSquashItem(Item.Properties properties) {
        super(properties
