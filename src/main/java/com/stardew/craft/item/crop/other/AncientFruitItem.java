...
public class AncientFruitItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{550, 687, 825, 1100};
    private static final int[] ENERGY_BY_QUALITY = new int[]{0, 0, 0, 0};
    private static final int[] HEALTH_BY_QUALITY = new int[]{0, 0, 0, 0};


    public AncientFruitItem(Item.Properties properties) {
        super(properties);
    }
