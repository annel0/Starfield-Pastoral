 ...
 * 杨桃
 */
public class StarfruitItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{750, 937, 1125, 1500};
    private static final int[] ENERGY_BY_QUALITY = new int[]{125, 175, 225, 325};
    private static final int[] HEALTH_BY_QUALITY = new int[]{56, 78, 101, 146};
