 ...
 * 草莓种子
 */
public class StrawberrySeedItem extends Item implements IStardewItem {

    public StrawberrySeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.STRAWBERRY_CROP.get().defaultBlockState(), 3);
