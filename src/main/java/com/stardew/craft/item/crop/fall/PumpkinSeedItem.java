 ...
 * 南瓜种子
 */
public class PumpkinSeedItem extends Item implements IStardewItem {

    public PumpkinSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.PUMPKIN_CROP.get().defaultBlockState(), 3);
