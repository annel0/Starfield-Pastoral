 ...
 * 茄子
 */
public class EggplantItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{60, 75, 90, 120};
    private static final int[] ENERGY_BY_QUALITY = new int[]{20, 28, 36, 52};
    private static final int[] HEALTH_BY_QUALITY = new int[]{9, 12, 16, 23};


    @SuppressWarnings("null")
    public EggplantItem(Item.Properties properties) {
        super(properties
