...
/** Seed item. */
public class CauliflowerSeedItem extends Item implements IStardewItem {

    public CauliflowerSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.CAULIFLOWER_CROP.get().defaultBlockState(), 3);
