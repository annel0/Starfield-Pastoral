...
/** Seed item. */
public class StarfruitSeedItem extends Item implements IStardewItem {

    public StarfruitSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.STARFRUIT_CROP.get().defaultBlockState(), 3);
