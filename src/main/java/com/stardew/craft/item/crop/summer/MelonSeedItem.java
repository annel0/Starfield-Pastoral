 ...
 * 甜瓜种子
 */
public class MelonSeedItem extends Item implements IStardewItem {

    public MelonSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.MELON_CROP.get().defaultBlockState(), 3);
