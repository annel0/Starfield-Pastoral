 ...
 * 蔓越莓
 */
public class CranberryItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{75, 93, 112, 150};
    private static final int[] ENERGY_BY_QUALITY = new int[]{38, 53, 68, 98};
    private static final int[] HEALTH_BY_QUALITY = new int[]{17, 23, 30, 44};


    @SuppressWarnings("null")
    public CranberryItem(Item.Properties properties) {
        super(properties
