 ...
 * 玫瑰仙子
 */
public class FairyRoseItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{290, 362, 435, 580};
    ...
    public FairyRoseItem(Item.Properties properties) {
        super(properties
