 ...
 * 向日葵
 */
public class SunflowerItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{80, 100, 120, 160};
    ...
    public SunflowerItem(Item.Properties properties) {
        super(properties
    ...
    public InteractionResult useOn(UseOnContext context) {
        InteractionResult result = FlowerPlacement.place(context, ModBlocks.SUNFLOWER_CROP);
