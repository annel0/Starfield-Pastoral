...
/** Seed item. */
public class SummerSpangleSeedItem extends Item implements IStardewItem {

    public SummerSpangleSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.SUMMER_SPANGLE_CROP.get().defaultBlockState(), 3);
