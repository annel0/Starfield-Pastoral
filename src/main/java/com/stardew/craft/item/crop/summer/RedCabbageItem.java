 ...
 * 红叶卷心菜
 */
public class RedCabbageItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{260, 325, 390, 520};
    ...
    public RedCabbageItem(Item.Properties properties) {
        super(properties
