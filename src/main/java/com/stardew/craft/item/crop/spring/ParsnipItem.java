 ...
 * 防风草
 */
public class ParsnipItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{35, 43, 52, 70};
    ...
    public ParsnipItem(Item.Properties properties) {
        super(properties
