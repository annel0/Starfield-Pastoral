 ...
 * 胡萝卜种�?
 */
public class CarrotSeedItem extends Item implements IStardewItem {

    public CarrotSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.CARROT_CROP.get().defaultBlockState(), 3);
