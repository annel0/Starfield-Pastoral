 ...
 * 大黄
 */
public class RhubarbItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{220, 275, 330, 440};
    private static final int[] ENERGY_BY_QUALITY = new int[]{0, 0, 0, 0};
    private static final int[] HEALTH_BY_QUALITY = new int[]{0, 0, 0, 0};


    public RhubarbItem(Item.Properties properties) {
        super(properties);
    }
