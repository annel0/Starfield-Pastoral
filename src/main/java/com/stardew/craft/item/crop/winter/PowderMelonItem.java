package com.stardew.craft.item.crop.winter;
 ...
 * 霜瓜
 */
public class PowderMelonItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{60, 75, 90, 120};
    private static final int[] ENERGY_BY_QUALITY = new int[]{63, 88, 113, 163};
    private static final int[] HEALTH_BY_QUALITY = new int[]{28, 39, 50, 73};


    @SuppressWarnings("null")
    public PowderMelonItem(Item.Properties properties) {
        super(properties
