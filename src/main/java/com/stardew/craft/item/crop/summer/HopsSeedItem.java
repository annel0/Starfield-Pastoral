...
/** Seed item. */
public class HopsSeedItem extends Item implements IStardewItem {

    public HopsSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.HOPS_CROP.get().defaultBlockState(), 3);
