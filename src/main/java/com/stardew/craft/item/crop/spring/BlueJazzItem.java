 ...
 * 蓝爵
 */
public class BlueJazzItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{50, 62, 75, 100};
    ...
    public BlueJazzItem(Item.Properties properties) {
        super(properties
    ...
    public InteractionResult useOn(UseOnContext context) {
        InteractionResult result = FlowerPlacement.place(context, ModBlocks.BLUE_JAZZ_CROP);
