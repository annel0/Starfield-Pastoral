 ...
 * 蒜种子
 */
public class GarlicSeedItem extends Item implements IStardewItem {

    public GarlicSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.GARLIC_CROP.get().defaultBlockState(), 3);
