 ...
 * 青豆种子
 */
public class GreenBeanSeedItem extends Item implements IStardewItem {

    public GreenBeanSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.GREEN_BEAN_CROP.get().defaultBlockState(), 3);
