...
/** Seed item. */
public class AmaranthSeedItem extends Item implements IStardewItem {

    public AmaranthSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.AMARANTH_CROP.get().defaultBlockState(), 3);
