...
/** Seed item. */
public class RadishSeedItem extends Item implements IStardewItem {

    public RadishSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.RADISH_CROP.get().defaultBlockState(), 3);
