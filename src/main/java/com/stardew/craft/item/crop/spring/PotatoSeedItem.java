 ...
 * 土豆种子
 */
public class PotatoSeedItem extends Item implements IStardewItem {

    public PotatoSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.POTATO_CROP.get().defaultBlockState(), 3);
