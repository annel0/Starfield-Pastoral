 ...
 * 辣椒
 */
public class HotPepperItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{40, 50, 60, 80};
    private static final int[] ENERGY_BY_QUALITY = new int[]{13, 18, 23, 33};
    private static final int[] HEALTH_BY_QUALITY = new int[]{5, 8, 10, 14};


    @SuppressWarnings("null")
    public HotPepperItem(Item.Properties properties) {
        super(properties
