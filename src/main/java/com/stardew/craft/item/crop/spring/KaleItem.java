 ...
 * 甘蓝菜
 */
public class KaleItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{110, 137, 165, 220};
    ...
    public KaleItem(Item.Properties properties) {
        super(properties
