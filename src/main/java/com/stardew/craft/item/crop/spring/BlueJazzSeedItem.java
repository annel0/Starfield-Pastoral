 ...
 * 蓝爵种子
 */
public class BlueJazzSeedItem extends Item implements IStardewItem {

    public BlueJazzSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.BLUE_JAZZ_CROP.get().defaultBlockState(), 3);
