...
/** Seed item. */
public class GrapeSeedItem extends Item implements IStardewItem {

    public GrapeSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.GRAPE_CROP.get().defaultBlockState(), 3);
