 ...
 * 小麦种子
 */
public class WheatSeedItem extends Item implements IStardewItem {

    public WheatSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.WHEAT_CROP.get().defaultBlockState(), 3);
