 ...
 * 金皮西葫芦种�?
 */
public class SummerSquashSeedItem extends Item implements IStardewItem {

    public SummerSquashSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.SUMMER_SQUASH_CROP.get().defaultBlockState(), 3);
