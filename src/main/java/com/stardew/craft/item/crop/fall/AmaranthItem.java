 ...
 * 苋菜
 */
public class AmaranthItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{150, 187, 225, 300};
    private static final int[] ENERGY_BY_QUALITY = new int[]{50, 70, 90, 130};
    private static final int[] HEALTH_BY_QUALITY = new int[]{22, 31, 40, 58};


    @SuppressWarnings("null")
    public AmaranthItem(Item.Properties properties) {
        super(properties
