 ...
 * 洋蓟
 */
public class ArtichokeItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{160, 200, 240, 320};
    private static final int[] ENERGY_BY_QUALITY = new int[]{30, 42, 54, 78};
    private static final int[] HEALTH_BY_QUALITY = new int[]{13, 18, 24, 35};


    @SuppressWarnings("null")
    public ArtichokeItem(Item.Properties properties) {
        super(properties
