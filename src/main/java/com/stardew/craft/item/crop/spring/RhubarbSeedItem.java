 ...
 * 大黄种子
 */
public class RhubarbSeedItem extends Item implements IStardewItem {

    public RhubarbSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.RHUBARB_CROP.get().defaultBlockState(), 3);
