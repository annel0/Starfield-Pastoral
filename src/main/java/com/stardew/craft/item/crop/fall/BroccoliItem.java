 ...
 * 西蓝花
 */
public class BroccoliItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{70, 87, 105, 140};
    ...
    public BroccoliItem(Item.Properties properties) {
        super(properties
