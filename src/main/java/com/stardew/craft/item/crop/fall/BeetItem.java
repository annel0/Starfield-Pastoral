 ...
 * 甜菜
 */
public class BeetItem extends Item implements IStardewItem {

    private static final int[] SELL_PRICE_BY_QUALITY = new int[]{100, 125, 150, 200};
    ...
    public BeetItem(Item.Properties properties) {
        super(properties
