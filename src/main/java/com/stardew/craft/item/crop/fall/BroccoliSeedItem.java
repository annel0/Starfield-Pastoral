...
/** Seed item. */
public class BroccoliSeedItem extends Item implements IStardewItem {

    public BroccoliSeedItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(@SuppressWarnings("null") UseOnContext context) {
        ...
        if (!level.isClientSide) {
            level.setBlock(abovePos, ModBlocks.BROCCOLI_CROP.get().defaultBlockState(), 3);
