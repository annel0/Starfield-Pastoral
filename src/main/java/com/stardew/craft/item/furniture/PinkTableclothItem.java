...
public class PinkTableclothItem extends SimpleStardewItem {
    public PinkTableclothItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        boolean applied = OakTableBlock.applyClothToConnectedTables(level, context.getClickedPos(), OakTableBlock.CLOTH_STYLE_PINK);
        if (!applied) {
