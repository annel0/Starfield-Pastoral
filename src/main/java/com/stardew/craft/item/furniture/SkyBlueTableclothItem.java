...
public class SkyBlueTableclothItem extends SimpleStardewItem {
    public SkyBlueTableclothItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        boolean applied = OakTableBlock.applyClothToConnectedTables(level, context.getClickedPos(), OakTableBlock.CLOTH_STYLE_SKY);
        if (!applied) {
