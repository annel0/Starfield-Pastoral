...
public class BlankTableclothItem extends SimpleStardewItem {
    public BlankTableclothItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        boolean applied = OakTableBlock.applyClothToConnectedTables(level, context.getClickedPos(), OakTableBlock.CLOTH_STYLE_BLANK);
        if (!applied) {
