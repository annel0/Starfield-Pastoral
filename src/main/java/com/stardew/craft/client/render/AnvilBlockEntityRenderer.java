...
public class AnvilBlockEntityRenderer implements BlockEntityRenderer<AnvilBlockEntity> {
    ...
    @Override
    public void render(@Nonnull AnvilBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
        ...
        poseStack.scale(innerW, innerH, 0.001f);
    ...
    @Override
    public boolean shouldRenderOffScreen(@Nonnull AnvilBlockEntity blockEntity) {
        return true;
    }
