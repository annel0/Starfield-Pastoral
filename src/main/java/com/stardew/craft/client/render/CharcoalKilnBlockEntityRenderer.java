...
public class CharcoalKilnBlockEntityRenderer implements BlockEntityRenderer<CharcoalKilnBlockEntity> {
    ...
    private static final float BUBBLE_Y = (float) (19.9 / 16.0 + 0.05);

    public CharcoalKilnBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @SuppressWarnings({ "null", "deprecation" })
    @Override
    public void render(@Nonnull CharcoalKilnBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
