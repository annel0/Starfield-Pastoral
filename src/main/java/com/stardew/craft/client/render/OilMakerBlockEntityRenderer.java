...
public class OilMakerBlockEntityRenderer implements BlockEntityRenderer<OilMakerBlockEntity> {
    ...
    @Override
    public void render(@Nonnull OilMakerBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
