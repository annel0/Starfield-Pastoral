 ...
 */
public class CaskBlockEntityRenderer implements BlockEntityRenderer<CaskBlockEntity> {
    ...
    @Override
    public void render(@Nonnull CaskBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
