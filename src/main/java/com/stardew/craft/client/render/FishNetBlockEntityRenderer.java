...
import com.stardew.craft.client.model.block.FishNetGeoModel;
...
public class FishNetBlockEntityRenderer extends StardewGeoBlockRenderer<FishNetBlockEntity> {
    public FishNetBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        super(new FishNetGeoModel());
    }

    @Override
    public void render(FishNetBlockEntity animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
