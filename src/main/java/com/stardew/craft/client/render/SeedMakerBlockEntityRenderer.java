...
public class SeedMakerBlockEntityRenderer implements BlockEntityRenderer<SeedMakerBlockEntity> {
    ...
    @Override
    public void render(@Nonnull SeedMakerBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
