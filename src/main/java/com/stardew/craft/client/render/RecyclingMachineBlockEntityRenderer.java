...
public class RecyclingMachineBlockEntityRenderer implements BlockEntityRenderer<RecyclingMachineBlockEntity> {
	...
	public RecyclingMachineBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
	}

	@SuppressWarnings({ "null", "deprecation" })
	@Override
	public void render(@Nonnull RecyclingMachineBlockEntity be, float partialTick, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int packedLight, int packedOverlay) {
	...
	@Override
	public boolean shouldRenderOffScreen(@Nonnull RecyclingMachineBlockEntity blockEntity) {
		return true;
	}
}