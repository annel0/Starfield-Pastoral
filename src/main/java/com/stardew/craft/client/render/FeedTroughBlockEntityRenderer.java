...
public class FeedTroughBlockEntityRenderer implements BlockEntityRenderer<FeedTroughBlockEntity> {
    public FeedTroughBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @SuppressWarnings("null")
    @Override
    public void render(@SuppressWarnings("null") FeedTroughBlockEntity be, float partialTick, @SuppressWarnings("null") PoseStack poseStack, @SuppressWarnings("null") MultiBufferSource buffer, int packedLight, int packedOverlay) {
        if (be == null) {
            return;
        }
