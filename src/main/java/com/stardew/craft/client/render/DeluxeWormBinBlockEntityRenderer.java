...
public class DeluxeWormBinBlockEntityRenderer implements BlockEntityRenderer<DeluxeWormBinBlockEntity> {
    ...
    @Override
    public void render(@SuppressWarnings("null") DeluxeWormBinBlockEntity be, float partialTick, @SuppressWarnings("null") PoseStack poseStack, @SuppressWarnings("null") MultiBufferSource buffer, int packedLight, int packedOverlay) {
