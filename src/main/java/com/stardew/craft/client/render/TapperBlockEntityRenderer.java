...
public class TapperBlockEntityRenderer implements BlockEntityRenderer<TapperBlockEntity> {
	...
	@Override
	public void render(@SuppressWarnings("null") TapperBlockEntity be, float partialTick, @SuppressWarnings("null") PoseStack poseStack, @SuppressWarnings("null") MultiBufferSource buffer, int packedLight, int packedOverlay) {
