...
public final class StarfallShockwavePostEffectClient {
    ...
    private StarfallShockwavePostEffectClient() {}
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        ...
        float strength = (1.0f - t) * effect.strength;
        if (strength <= 0.001f) {
            return;
        }

        float radius = effect.radiusNorm * (0.45f + 0.65f * t);
        ...
        RenderSystem.setShaderTexture(1, RING_TEXTURE);
