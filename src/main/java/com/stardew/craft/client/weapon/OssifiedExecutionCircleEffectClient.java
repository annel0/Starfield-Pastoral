...
public final class OssifiedExecutionCircleEffectClient {
    ...
    private static final ResourceLocation RING_TEXTURE = ResourceLocation.fromNamespaceAndPath(
        StardewCraft.MODID,
        "textures/gui/weapon_skill/ossified_blade_circle.png"
    );
    ...
    public static void add(float x, float y, float z, float radius, int durationTicks) {
        RINGS.add(new Ring(new Vec3(x, y, z), radius, durationTicks));
    }
    ...
    private static final class Ring {
        ...
        private Ring(Vec3 pos, float radius, int durationTicks) {
            this.pos = pos;
            this.radius = radius;
